...
class GATSBIv1_GMM(nn.Module):
    def __init__(self, input_dim=2, hidden_dim=64, gat_out_dim=64, prediction_length=25, num_modes=5):
        super(GATSBIv1_GMM, self).__init__()
        # Params
    ...
    def forward(self, ego_hist, neighbor_hists, adj, pred_cv, pred_ca, pred_bk, pred_xk, dist):
        ...
        return mu_x, mu_y, sigma_x, sigma_y, rho, pi, attn
    
    
def load_gatsbi_modelv1_gmm(model_path, device, prediction_length):
