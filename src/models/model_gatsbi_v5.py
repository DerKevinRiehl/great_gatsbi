...
class GATSBIv5(nn.Module):
    ...
    def encode_agent_futures(self, ego_pred, neighbor_hists):
        ...
        B, Tp, Ni = ego_pred.shape

        # time decay
        decay_vec = torch.arange(0, Tp).to(device=ego_pred.device) * self.history_dt
