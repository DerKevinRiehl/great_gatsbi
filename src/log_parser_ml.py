...
def process_results(base_dir, model_name, prediction_lengths):      
    # Store results across prediction lengths for markdown summary later
    results_summary = {}
    ...
    for prediction_length in prediction_lengths:
        ...
        for split in range(1, 6):
            for exp in range(1, 50):
                file_name = f"{model_name}_{prediction_length}_split_{split}_{exp:02d}.model_perf.txt"
    ...
    print(f"| {model_name} | {best_experiments[25][2]:.4f} | {best_experiments[50][2]:.4f} | {best_experiments[75][2]:.4f} | {best_experiments[100][2]:.4f} | {best_experiments[25][4]:.4f} | {best_experiments[50][4]:.4f} | {best_experiments[75][4]:.4f} | {best_experiments[100][4]:.4f} |")
    print(f"|       | [{best_experiments[25][3]:.4f}] | [{best_experiments[50][3]:.4f}] | [{best_experiments[75][3]:.4f}] | [{best_experiments[100][3]:.4f}] | [{best_experiments[25][5]:.4f}] | [{best_experiments[50][5]:.4f}] | [{best_experiments[75][5]:.4f}] | [{best_experiments[100][5]:.4f}] |")
